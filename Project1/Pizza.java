...
class Pizza extends JPanel implements ActionListener
{
...
JLabel cost;
String s1[]={"pizza.jpg"};
String s2[]={"480","480","540","540","540","450","440","480","340"};
String s3[]={"Veggie ","Paneer Pizza","Chicken fried","Triple Chicken","Italiano","Tandoori","Veggie Lovers","Double Trouble","Double Cheese"};
...
public void actionPerformed(ActionEvent e)
{
	...
	if(l1[i].isSelected()==false)
	{
       ...
       if(l1[7].isSelected())
		...
		full6=project3.pa.getText();
		System.out.println(full6);
		project3.pizza=full6;	
     
	}
		project3.pizzasum6=sum6;
}
