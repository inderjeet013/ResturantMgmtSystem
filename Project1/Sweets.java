...
class Sweets extends JPanel implements ActionListener
{
...
JLabel image,text;
JLabel cost;
String s1[]={"methai.jpg"};
String s2[]={"300","120","290","200","300","400","200","350","400"};
String s3[]={"Gulab Jamun","Jalebi","Rasgulla","Ras Malai","Gajar Ka Halwa","Kaju Katli","Rabri","Ladoo","Barfi"};
...
cost=new JLabel("price(Rs per Kg)");//Main cost Label
cost.setBounds(390,5,190,20);
//cost.setOpaque(true);
...
public void actionPerformed(ActionEvent e)
{
	...
	if(l1[i].isSelected()==false)
	{
       ...
       if(l1[7].isSelected())
		...
		full5=project3.pa.getText();
		System.out.println(full5);
		project3.sweets=full5;	
	}
		project3.sweetssum5=sum5;
}
