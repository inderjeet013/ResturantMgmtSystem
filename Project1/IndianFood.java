...
class IndianFood extends JPanel implements ActionListener
{
static JCheckBox l1[];
JLabel p1,p2,p3;
JLabel c1[];
JLabel image,text;
JLabel cost;
String s1[]={"vegetarian-food.jpg"};
String s2[]={"10","10","12","100","130","120","100","100","80"};
String s3[]={"Roti","Missi Roti","Non Roti","Matar Paneer","Shahi Paneer","Palak Paneer","Razma","Chole","Aaloo Matar"};
static JTextField fl[];
static JButton b1;
static String full12;
int y=50;
int x[]=new int[9];
int sum2;
...
public void actionPerformed(ActionEvent e)
{
	...
	full12=project3.pa.getText();
	System.out.println(full12);
	project3.indianfood=full12;
}
	project3.indianfoodsum2=sum2;
