...
class ChineseFood extends JPanel implements ActionListener
{		
static JCheckBox l1[];
JLabel p1,p2,p3;
JLabel c1[];
JLabel image,text;
JLabel cost;
String s1[]={"chinese.jpg"};
String s2[]={"50","60","60","70","60","100","70","50","120"};
String s3[]={"Momos","Manchurian","Fry Manchurian","Chilli Potato","Spring Rolls","Chilli chicken","Manchow soup","Noodles","Chilli Paneer"};
...
public void actionPerformed(ActionEvent e)
{
	...
	if(e.getSource()==b1)
	{
		...
		full3=project3.pa.getText();
		System.out.println(full3);
		project3.chinesefood=full3;	
	}
		project3.chinesefoodsum3=sum3;
}	
